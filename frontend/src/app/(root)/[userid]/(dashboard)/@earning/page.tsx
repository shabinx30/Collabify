...
const Earning = () => {
    ...
    return (
        <section className="flex-1 min-w-0">
            <h3 className="font-semibold dark:text-base mb-1">Earning</h3>
            <div className="bg-gray-100 dark:bg-[#2b2b2b] w-full h-full min-h-[300px] md:min-h-0 rounded-3xl px-2 sm:px-3 pt-3 pb-2">
