    ...
    return (
        <div className="fixed flex p-3 bg-[#f0f5ff] dark:bg-[#0B1437]">
            ...
            >
                ...
                <div>
                    <ul className="flex flex-col text-[1.05rem]">
                        <li onClick={() => router.push("/admin/settings")} className="flex gap-3 items-center text-[#9ab2d0] dark:text-[#9ab2d0] hover:text-black dark:hover:text-white duration-150 px-4 py-2 rounded-2xl cursor-default">
                            <RiSettings3Fill
                                size={20}
                                className={` ${
            ...
            <div className="flex-1 pl-4">
                ...
                <div className="pt-[5em]">{children}</div>
            </div>
        </div>
    );
};
