...
const Hero = () => {
    return (
        <div className="w-full bg-white flex flex-col items-center px-[10em] pt-[4em]">
            <h1 className="text-black text-5xl font-semibold">
                Symplifiying Influencer Marketing For Everyone
            </h1>
            <p className="text-gray-800 mt-[1em] w-[50%] text-center leading-[1.2]">
            ...
            <div className="bg-[#FFF5CF] w-full flex p-2 rounded-2xl my-[4em] text-black">
                ...
                <div className="flex-1 pl-4 pr-2 py-2">
                    <div className="flex flex-col h-full justify-between">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex gap-14 justify-center text-lg font-semibold">
                                <h2>Jennifer</h2>
                                <div>
                                    <h2>Followers</h2>
