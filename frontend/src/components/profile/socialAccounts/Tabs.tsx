...
export default function ProfileTabs({ userId }: { userId: string | null }) {
    ...
    const tabs = [
        ...
        //                 currentRoute === `/${userId}/reels` ? "" : "contrast-15"
        //             }`}
    ...
    return (
        <div className="relative mt-6 z-500 dark:bg-black border-t border-[#DBDBDB] dark:border-[#2e2e2e] md:mr-8 lg:mx-[6em] pb-[0.5em]">
                ...
                {tabs.map((tab) => (
                    ...
                    >
                        ...
                        {currentRoute === tab.path && (
                            <motion.div
                                layoutId="active-tab"
                                className="absolute top-0 left-0 w-full h-[2px] bg-black dark:bg-white rounded-full"
